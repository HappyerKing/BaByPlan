...
// Utils
import { DateManager, DiaryManager } from "../../common";
...
class Positive extends PureComponent {
  ...
  //=================== 控件 ===================//
  render() {
    let month = DateManager.getDaysInOneMonth(
    ...
    if (this.props.diarys[this.props.currentYear] != null) {
      if (this.props.diarys[this.props.currentYear][this.props.month] != null) {
        diary = this.props.diarys[this.props.currentYear][this.props.month][
          "array"
        ].length;
      }
    }
      ...
      >
        <View style={styles.calender}>
          ...
          <Text style={styles.day}>
            {DateManager.getMonthEn(this.props.month - 1)}
          </Text>
        </View>
        <View style={styles.bottom}>
          <View style={styles.bottomLeft}>
            <Text style={styles.diarys}>
              {diary}/{month}
            </Text>
