    ...
    return (
      <TabNavigator>
        <TabNavigator.Item
          ...
          renderSelectedIcon={() => (
            <Icon name="trophy" size={30} color="#91627b" />
          )}
        ...
        <TabNavigator.Item
          selected={this.state.selectedTab === "BabyGrowth"}
          title="成长"
          renderIcon={() => <Icon name="trophy" size={30} />}
          renderSelectedIcon={() => (
            <Icon name="trophy" size={30} color="#91627b" />
          )}
          onPress={this.onPress.bind(this, "BabyGrowth")}
        >
          <GrowthHome navigation={this.props.navigation} />
        </TabNavigator.Item>
        <TabNavigator.Item
          ...
          renderSelectedIcon={() => (
            <Icon name="camera" size={30} color="#91627b" />
          )}
        ...
        <TabNavigator.Item
          ...
          renderSelectedIcon={() => (
            <Icon name="calendar" color="#91627b" size={30} />
          )}
